...
%
%   survey    = bathy/topo data (structure format)
%                   >> survey =
%                          x: [449881x1 double]
%                          y: [449881x1 double]
%                          z: [449881x1 double]
...
%
%Usage: 
%   [Runup]=convertRunup_ArgusTimestack_madbeach(runupName,survey)
%--------------------------------------------------------------------------
function [Runup]=convertRunup_ArgusTimestack_madbeach(runupName,survey)
...
%---convert horizontal runup (x-dimension) to vertical runup (z-dimension) using lidar data
