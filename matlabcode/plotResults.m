...
year  = 2020;
month = 9;  monthNum=num2str(month,'%02d');
day   = 16;  dayNum=num2str(day,'%02d');
hr1   = 16;
% hr2  = 18;
...
PP = patch([TWL.u(1,end) TWL.u(3,end) TWL.u(3,inan(1)) TWL.u(1,inan(1))],...
    [TWL.v(1,end) TWL.v(3,end) TWL.v(3,inan(1)) TWL.v(1,inan(1))],'r');
set(PP,'FaceAlpha',.2); set(PP,'EdgeColor','none')
hold on;  plot(TWL.u(2,:), TWL.v(2,:),'-r','linewidth',2);
