...
dataDIR = ['\\gs\stpetersburgFL-G\Coastal_Change_Hazards\Archive\Data\2016\2016-363-DD_20161028\madbeach\',num2str(year),'\cx'];
%dataDIR = ['C:\Users\kbendik\Documents\madbeach\',num2str(year),'\cx'];

%---save runup timeseries files to:
saveDIR = ['\\gs\StPetersburgFL-G\NACCH\Imagery\madbeach\runup\',num2str(year)];%,'\'];
%saveDIR = ['C:\Users\kbendik\Documents\madbeach\runup\',num2str(year)];
